export default {
  ...
  // ✅ Responsável (avatar preparado)
  team: {
    title: "Responsáveis",
    members: [{ name: "Mayya Kiryan", avatar: null }],
  },

  // ✅ NOVO: Parceria (logo preparado)
  officialPartner: {
    title: "Parceria",
    name: "Sunlive",
    description: "Parceiro oficial do evento e apoio à organização.",
    logo: null, // depois metes import aqui
  },

  // ✅ Sobre o Evento (texto + destaques)
  description: {
    ...
    highlights: {
      title: "Destaques",
      icon: "check", // ✅ novo (consome o CheckIcon)
      items: [
